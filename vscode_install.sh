...
wget https://github.com/cdr/code-server/releases/download/${VERSION}/code-server${VERSION}-${RELEASE}-linux-x86_64.tar.gz
tar -xvzf code-server${VERSION}-${RELEASE}-linux-x86_64.tar.gz
rm code-server${VERSION}-${RELEASE}-linux-x86_64.tar.gz
mv code-server${VERSION}-${RELEASE}-linux-x86_64/  "${INSTALL_DIR}/vscode-server"
